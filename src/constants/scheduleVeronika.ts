...
const TIME_TABLE_1 = [
  {
    day: DAYS.mon,
    lessons: [
      { name: L.YADS_MATEMATYKA, time: TIME_FIRST_CLASSES[1] },
  ...
  },
  {
    ...
    lessons: [
      ...
      { name: L.KHOREOHRAFIYA, time: TIME_FIRST_CLASSES[2] },
      { name: L.MATEMATYKA, time: TIME_FIRST_CLASSES[3] },
      { name: L.OBRAZOTVORCHE, time: TIME_FIRST_CLASSES[4] },
      { name: L.YADS_PRYRODA, time: TIME_FIRST_CLASSES[5] },
    ],
  },
  {
    day: DAYS.wed,
    lessons: [
      { name: L.UKRAYINSKA_MOVA, time: TIME_FIRST_CLASSES[1] },
      { name: L.INFORMATYKA, time: TIME_FIRST_CLASSES[2] },
      { name: L.ANHLIYSKA_MOVA, time: TIME_FIRST_CLASSES[3] },
      { name: L.MATEMATYKA, time: TIME_FIRST_CLASSES[4] },
      { name: L.YADS_TRUD_NAV, time: TIME_FIRST_CLASSES[5] },
    ],
  },
  {
    day: DAYS.thu,
  ...
  },
  {
    ...
    lessons: [
      ...
      { name: L.MUZYKA, time: TIME_FIRST_CLASSES[3] },
      { name: L.YADS_PRYRODA, time: TIME_FIRST_CLASSES[4] },
      { name: L.KHRYSTYYANSKA_ETYKA, time: TIME_FIRST_CLASSES[5] },
    ],
  },
];
...
const TIME_TABLE_2 = [
  ...
  },
  {
    day: DAYS.tue,
    lessons: [
      { name: L.KHOREOHRAFIYA, time: TIME_FIRST_CLASSES[1] },
      { name: L.UKRAYINSKA_MOVA, time: TIME_FIRST_CLASSES[2] },
      { name: L.MATEMATYKA, time: TIME_FIRST_CLASSES[3] },
      { name: L.OBRAZOTVORCHE, time: TIME_FIRST_CLASSES[4] },
      { name: L.YADS_PRYRODA, time: TIME_FIRST_CLASSES[5] },
  ...
  },
  {
    day: DAYS.fri,
    lessons: [
      { name: L.MUZYKA, time: TIME_FIRST_CLASSES[1] },
      { name: L.MATEMATYKA, time: TIME_FIRST_CLASSES[2] },
      { name: L.UKRAYINSKA_MOVA, time: TIME_FIRST_CLASSES[3] },
      { name: L.YADS_PRYRODA, time: TIME_FIRST_CLASSES[4] },
      { name: L.KHRYSTYYANSKA_ETYKA, time: TIME_FIRST_CLASSES[5] },
