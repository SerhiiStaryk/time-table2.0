...
const LESSONS: {
  ...
  [L.UKRAYINSKA_MOVA]: { name: L.UKRAYINSKA_MOVA, cab: 314 },
  [L.MATEMATYKA]: { name: L.MATEMATYKA, cab: 305 },
  [L.ANHLIYSKA_MOVA]: { name: L.ANHLIYSKA_MOVA, cab: '109' },
  ...
  [L.MUZYKA]: { name: L.MUZYKA, cab: 215 },
...
const TIME_TABLE_1 = [
  ...
  },
  {
    day: DAYS.fri,
    lessons: [
      { ...LESSONS[L.PIZNAYEMO_PRYRODU], time: TIME[6], cab: 203 },
      { ...LESSONS[L.ANHLIYSKA_MOVA], time: TIME[7] },
      { ...LESSONS[L.UKRAYINSKA_MOVA], time: TIME[8], cab: 310 },
      { ...LESSONS[L.INFORMATYKA], time: TIME[9] },
      { ...LESSONS[L.NIMETSKA_MOVA], time: TIME[10] },
    ],
  },
];
...
const TIME_TABLE_2 = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { ...LESSONS[L.ANHLIYSKA_MOVA], time: TIME[7] },
      { ...LESSONS[L.UKRAYINSKA_MOVA], time: TIME[8], cab: 310 },
      { ...LESSONS[L.INFORMATYKA], time: TIME[9], cab: 309 },
      { ...LESSONS[L.NIMETSKA_MOVA], time: TIME[10] },
    ],
  },
];
